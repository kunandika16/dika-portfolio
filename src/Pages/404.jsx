  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-sky-100 flex items-center justify-center px-4">
      <div className="text-center">
        ...
        {/* Illustration */}
        <div className="mb-8">
          <div className="w-32 h-32 mx-auto bg-sky-100 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-sky-600 text-white rounded-lg hover:bg-sky-700 transition-colors duration-200 shadow-md hover:shadow-lg"
          >
            <Home size={20} />
            Beranda
          </button>
